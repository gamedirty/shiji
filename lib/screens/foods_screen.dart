...
class _FoodsScreenState extends State<FoodsScreen> {
        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  icon: const Icon(Icons.add_circle_rounded, size: 28, color: AppColors.accent),
          ...
          const Padding(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 11.5, height: 1.4, color: AppColors.subtext),
            ),
          ),
          const SizedBox(height: 12),
          Padding(
  ...
  void _openEditor() {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (_) => _seg == 0 ? const FoodEditScreen() : const MealEditScreen(),
    ));
  }
}
      ...
      itemBuilder: (context, i) {
        ...
        return Dismissible(
          ...
          background: Container(
            ...
            decoration: ShapeDecoration(color: AppColors.danger, shape: RoundedSuperellipseBorder(borderRadius: BorderRadius.circular(20))),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: ShapeDecoration(
          ...
          shadows: const [BoxShadow(color: Color(0x06000000), blurRadius: 10, offset: Offset(0, 3))],
        ),
        child: Row(
          children: [
            ...
            const Icon(Icons.chevron_right_rounded, size: 22, color: Color(0xFFC6C9CF)),
          ],
        ),
      ),
    );
...
class _MealsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (meals.isEmpty) {
      return const _EmptyHint(emoji: '🍱', text: '没有找到组合餐\n点右上角 + 把常吃的一餐组合保存下来');
    }
      ...
      child: Column(
        ...
        children: [
          ...
          Text(text,
              ...
              style: const TextStyle(fontSize: 13, height: 1.6, color: AppColors.subtext)),
        ],
      ),
    );
  }
